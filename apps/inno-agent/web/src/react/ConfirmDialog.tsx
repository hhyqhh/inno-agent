			...
			>
				<div className="flex items-start gap-3">
					...
					<div className="min-w-0 flex-1">
						<h2 id="confirm-dialog-title" className="text-base font-semibold text-[var(--inno-text)]">{title}</h2>
						<p id="confirm-dialog-description" className="mt-1.5 text-sm leading-6 text-[var(--inno-text-muted)]">{description}</p>
					</div>
					<button
						type="button"
