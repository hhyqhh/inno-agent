...
function ModelEditForm({ model, settings, onClose }: {
	...
	return (
		<div className="bg-[var(--inno-surface)] p-3">
...
function NewProviderForm() {
	...
	return (
		<div className="bg-[var(--inno-surface)]">
			<button
...
function ContentHubSettings({ settings }: { settings: InnoSettings }) {
	...
	return (
		<div className="min-w-0 bg-[var(--inno-surface)] p-4">
...
function MemorySettings({ settings }: { settings: InnoSettings }) {
	...
	return (
		<div className="bg-[var(--inno-surface)] p-4">
