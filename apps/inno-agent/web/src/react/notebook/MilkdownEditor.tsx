...
export function MilkdownEditor({ value, onChange, editorKey, readOnly = false, toolbarAction, onUploadImage, resolveImageUrl }: MilkdownEditorProps) {
	...
	return (
		<div className="inno-milkdown-editor flex min-h-0 flex-1 flex-col">
			{error ? <div className="border-b border-red-100 bg-red-50 px-4 py-2 text-xs text-red-700">{error}</div> : null}
			{!error && !ready ? (
