...
export type PersonalLinkRelationType =
	| "historical_or_influential"
...
export interface PersonalLinkFeedback {
	...
	generated_by: "rules" | "model" | "unavailable";
	reviewed_at: string;
}
...
export interface PersonalLinkCreateResponse extends PersonalLink {
